...
class LoginView:
    ...
    def __init__(self, root, handle_login, handle_show_create_user_view,
        ...
        self.handle_show_limited_view = handle_show_limited_view
        self.frame = None
    ...
    def initialize(self):
        ...
        limited_version_button = ttk.Button(
            master=self.frame,
            text='Limited Version',
            command=self.handle_show_limited_view
        )
        ...
        limited_version_button.grid(padx=5, pady=5, sticky=constants.EW)
